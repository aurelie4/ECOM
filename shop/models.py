...
class CategorieSocio(models.Model):
...
class Client(models.Model):
    ...
    CategorieSocio = models.ForeignKey(CategorieSocio, on_delete=models.SET_NULL, null=True, related_name='clients')
...
class Produit(models.Model):
 ...
 #affiche les produits sur le site en fonction de la date d'ajout   
    class Meta:
        ordering = ['-date_ajout']
...
#calcul du prix total du produit placé dans le panier en fonction de la quantité choisie
    @property
    def get_total(self):
