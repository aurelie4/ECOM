...
class ClientModelAdmin(admin.ModelAdmin):
    list_display = ('user','name','email', 'nb_enfants', 'CategorieSocio')
    
 
class CategorieSocioModelAdmin(admin.ModelAdmin):
    list_display = ('nom_categ','description')
...
admin.site.register(CategorieSocio, CategorieSocioModelAdmin)
...
admin.site.site_title = "GoldenLine"
admin.site.site_header = "GoldenLine"
admin.site.index_title = "GoldenLine"